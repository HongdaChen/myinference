...
def get_args():
    ...
    argparser.add_argument( '-c', '--cfg', metavar='C', default='config/ps_gat.yaml', help='The Configuration file')
    argparser.add_argument( '-s', '--seed', default=100, type=int, help='The random seed')
    argparser.add_argument( '-m', '--ckpt', default='model/model.pth', type=str, help='The model path')
